package com.ocean.netty.simple;
...
public class NettyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception{
        ...
        //比如这里我们有一个非常耗时间的业务-> 异步执行 ->提交该channel 对应的 NIOEventLoop 的 taskQueue 中
        ...
        //用户自定义时间任务-> 该任务是提交到scheduleTaskQueue中
...
//        System.out.println("看看 channel和pipeline的关系");
//        Channel channel = ctx.channel();
//        ChannelPipeline pipeline = ctx.pipeline();//本质是一个双向链接，出站入站
//
//        //将msg转成一个ByteBuf
//        //ByteBuf 是 Netty提供的，不是NIO的ByteBuffer  ByteBuf 性能更高
